...
import { createWine, getAllWines, getWineById, updateWine, archiveWine, getArchivedWinesOfRestarant, restoreWine, getWineAnalytics } from "../controllers/wineController.mjs";
...
router.get("/deleted", authMiddleware, checkPermission("manage_wines"), getArchivedWinesOfRestarant);
...
router.delete("/:uuid", authMiddleware, checkPermission("manage_wines"), archiveWine);
