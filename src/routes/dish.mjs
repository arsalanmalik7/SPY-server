...
import { createDish, getAllDishes, getDishById, updateDish, deleteDish, getAllDeletedDishes, restoreDish, getDishAnalytics } from "../controllers/dishController.mjs";
...
router.get("/deleted", authMiddleware, checkPermission("manage_dishes"), getAllDeletedDishes);
...
router.delete("/:uuid", authMiddleware, checkPermission("manage_dishes"), deleteDish);
